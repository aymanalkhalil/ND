                ...
                <div class="row align-items-end">
                  <div class="col-lg-12">
                    <div class="mb-5 text-center">
                      ...
                      <p class="lead mb-0 text-danger text-center">عزيزي/تي المشارك/ة:يرجى كتابة معلومات التواصل في التعليق المرفق مع جميع مشاركاتك متمنين لك/ي دوام التوفيق والنجاح 😍🌹</p>
                    </div>
                ...
                <div class="row align-items-end">
                  <div class="col-lg-12">
                    <div class="mb-5 text-center">
                      ...
                      <h2 class="mt-4 mb-0">مشاركة الأعمال</h2>
                      <p class="lead mb-0 text-center">هنا يمكنك مشاركة أعمالك لعرضها في المنصة.</p>
                      <p class="lead mb-0 text-danger text-center">عزيزي/تي شريك/ة النجاح:يرجى كتابة معلومات التواصل في التعليق المرفق مع جميع مشاركاتك متمنين لك/ي دوام التوفيق والنجاح 😍🌹</p>
                ...
                <div class="row align-items-end">
                  <div class="col-lg-12">
                    <div class="mb-5 text-center">
                      ...
                      <h2 class="mt-4 mb-0">مشاركة الأعمال</h2>
                      <p class="lead mb-0 text-center">هنا يمكنك مشاركة أعمالك لعرضها في المنصة.</p>
                      <p class="lead mb-0 text-danger text-center">عزيزي/تي صاحب/ة المنتج التجاري:يرجى كتابة معلومات التواصل في التعليق المرفق مع جميع مشاركاتك متمنين لك/ي دوام التوفيق والنجاح 😍🌹</p>
