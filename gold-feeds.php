...
<section class="position-relative">
    ...
    <div class="container">
        <div class="row  text-center">
            <div class="col">
                <h1> شركاء النجاح والرعايات الذهبية</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center bg-transparent p-0 m-0">
                        <li class="breadcrumb-item"><a class="text-dark" href="index.php">الرئيسية</a>
                        </li>
                        <li class="breadcrumb-item active text-success" aria-current="page"> شركاء النجاح والرعايات الذهبية</li>
                        <?php if (isset($_SESSION['sponsor_id'])) {
                            ...
                            if ($result['active'] == 1) { ?>
                                <li class="breadcrumb-item"><a class="text-dark" href="sponsor-contest.php"> مسابقات شركاء النجاح الذهبية</a>
                                </li>
                        <?php
                            }
                        } ?>
