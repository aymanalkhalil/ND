...
<footer class="py-11 bg-success position-relative" data-bg-img="assets/images/bg/03.png">
    ...
    <div class="container mt-11">
        <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row">
                    <div class="col-12 col-sm-4 navbar-dark text-center">
                    ...
                    <div class="col-12 col-sm-4 mt-6 mt-sm-0 navbar-dark">
                        ...
                        <ul class="navbar-nav list-unstyled mb-0">
                            <li class="mb-3 nav-item"><a class="nav-link" href="terms-and-conditions.html">Term
                                    Of Service</a>
                            </li>
                ...
                <div class="row mt-5">
                    <div class="col-12 col-sm-6">
                        <a class="footer-logo text-white h2 mb-0" href="index.php">
                            منصة اليوم الوطني <span class="font-weight-bold">السعودي ٩٠</span>
                        </a>
                    </div>
        ...
        <div class="row text-white text-center mt-8">
            <div class="col">
                <hr class="mb-8">جميع الحقوق محفوظة<u><a class="text-white" href=""></a></u> | منصة اليوم الوطني السعودي ٩٠ </div>
