...
<body>
    <div style="border:5px solid black " class='mt-2 ml-3 mr-3'>
        <div class="container-fluid ">
            <div class="row">
                <div class="col-2 ">
                    <div class="row">
                        <img src="assets/images/primary/green-nav-logo.png" width="298px">
                ...
                <div class="col-7">
                    ...
                    ?>
                        <div class="text-center f-2 text-dark mt-5" dir="rtl">
                            المشارك/ة: <?php echo "<b class='font-weight:bold text-success'>" . $row['user_name'] . "</b>"  ?>
                        </div>

                        <div class="col-12  text-center text-dark f-2 " dir="rtl" style="margin-top:50px">
                        ...
                        <img src="assets/images/stamp.png" width="125px">

                    <?php } elseif (isset($_GET['m'])) {
                        $row2 = mysqli_fetch_assoc($query2);
                    ?>
                        <div class="text-center f-2 text-dark mt-5" dir="rtl">
                            صاحب/ة المنتج التجاري: <?php echo "<b class='font-weight:bold text-success'>" . $row2['merchant_name'] . "</b>" ?>
                        </div>
                    ...
                    ?>
                        <div class="text-center f-2 text-dark mt-5" dir="rtl">
                            شريك/ة النجاح : <?php echo "<b class='font-weight:bold text-success'>" .  $row3['sponsor_name'] . "</b>" ?>
                        </div>

                        <div class="col-12 text-center text-dark f-2 " dir="rtl" style="margin-top:89px">
                ...
                <div class="col-3 d-flex justify-content-end pull-right">
                    ...
                    <div class="row">
                        <img src="assets/images/certificate.png" height="650px">
                    </div>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center ">
                    ...
                    <div class="row " style="margin-left:350px">
                        <img src="assets/images/global.jpeg" style="width:12%; max-width:280px;">

                        <img src="assets/images/logos/talent1.jpeg" style="width:12%; max-width:280px;">



                        <img src="assets/images/lit-club.jpeg" style="width:12%; max-width:280px;">

                        <img src="assets/images/logo-ar.jpeg" style="width:12%; max-width:280px;">
