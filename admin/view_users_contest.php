...
if (isset($_POST['delete'])) {
    ...
    unlink('../assets/upload_users/' . $file);

    $query = "DELETE FROM uploads_users where upload_user_id='$upload_id'";
    ...
    if ($result) {
        $error = " <div class='alert alert-success text-center alert-dismissible text-center'>
             ...
             window.location.href = 'view_users_contest.php';
             }, 2000);</script>";
    } else {
...
if (isset($_POST['delete_contest'])) {
    ...
    unlink('../assets/user_contest_uploads/' . $file_upload);
    mysqli_query($conn, "DELETE FROM voters_active_contest where user_contest_id='$contest_id'");
    mysqli_query($conn, "DELETE FROM voter_contest  where contest_id='$contest_id'");
    $query = "DELETE FROM user_contest where contest_id='$contest_id'";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            View Users Contest & Shares - عرض اعمال ومشاركات المستخدمين

        </h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>

            <li class="active"> View Users Contest - عرض اعمال المستخدمين
            </li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header text-center">
                        <h3 class="box-title">Users Contests Shares - تفاصيل مشاركات المستخدمين</h3>
                        <!-- <div class="box-tools">
                    ...
                    <section class="content">
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php
                                $get_shares = mysqli_query($conn, "SELECT * FROM uploads_users INNER JOIN users on uploads_users.user_id=users.user_id
                                ...
                                if (mysqli_num_rows($get_shares) == 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($get_shares)) {
                                        $typeArr = explode('.', $row['upload_user_file']);
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo !empty($row['upload_user_description']) ? $row['upload_user_description'] : 'لا يوجد تعليق مرفق' ?></td>
                                            <td>

                                                <?php if ($type == 'image') { ?>
                                                    <a href="../assets/upload_users/<?php echo $row['upload_user_file'] ?>">
                                                        <img src="../assets/upload_users/<?php echo $row['upload_user_file'] ?>" width="150px" alt="" srcset="">
                                                    </a>

                                                <?php } elseif ($type == 'video') { ?>
                                                    <a class="popup-img h2 text-white" href="../assets/upload_users/<?php echo $row['upload_user_file'] ?>">
                                                        <video class="img-center" width="250px" controls>
                                                            <source src="../assets/upload_users/<?php echo $row['upload_user_file'] ?>">
                                                        </video>
                                                    </a>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <p class='text-red text-center font-weight-bold'>هل انت متأكد من حذف هذه المشاركة ؟</p>
                                                            ...
                                                            <form action='' method="POST" role="form">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="upload_id" value="<?php echo $row['upload_user_id'] ?>">
                                                                    <input type="hidden" name="file" value="<?php echo $row['upload_user_file'] ?>">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header text-center">
                        <h3 class="box-title">Users Contests Information - تفاصيل اعمال المستخدمين</h3>
                        <!-- <div class="box-tools">
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                <input type="text" name="table_search" class="form-control pull-right" placeholder="Search">
                    ...
                    <section class="content">
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                $contest_information = mysqli_query($conn, "SELECT * FROM user_contest INNER JOIN users on user_contest.user_id=users.user_id
                                ORDER BY contest_id DESC LIMIT $offset,$num_records_per_page ");
                                ...
                                if (mysqli_num_rows($contest_information) == 0) {
                                    ...
                                    $i = 1;
                                    $total_user_contest = mysqli_query($conn, "SELECT * FROM user_contest");
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $all_contests['user_name']  ?></td>
                                            <td><?php echo $all_contests['user_mobile']  ?></td>
                                            <td><?php echo $all_contests['user_email']  ?></td>
                                            <td>

                                                <?php if ($type == 'image') { ?>
                                                    <a href="../assets/user_contest_uploads/<?php echo $all_contests['upload_file'] ?>">
                                                        <img src="../assets/user_contest_uploads/<?php echo $all_contests['upload_file'] ?>" width="150px" alt="" srcset="">
                                                    </a>

                                                <?php } elseif ($type == 'video') { ?>
                                                    <a class="popup-img h2 text-white" href="../assets/user_contest_uploads/<?php echo $all_contests['upload_file'] ?>">
                                                        <video class="img-center" width="250px" controls>
                                                            <source src="../assets/user_contest_uploads/<?php echo $all_contests['upload_file'] ?>">
                                                        </video>
                                                    </a>
                                            ...
                                            <td>
                                                <a href="view_user_votes.php?c_id=<?php echo $all_contests['contest_id'] ?>" class="btn btn-info"> <i class="fa fa-eye"></i></a>
                                                ...
                                                <div class="modal fade" id="exampleModal2<?php echo $i ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action='' method="POST" role="form">
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="contest_id" value="<?php echo $all_contests['contest_id'] ?>">
